...
const FOODS = [
  ...
  { id: 'nanjingkaoya', name: '南京烤鸭', emoji: '🍗', category: '名菜',
    desc: '金陵烤鸭，皮酥肉嫩、卤汁香甜，先烤后浇卤，与北京烤鸭风味迥异。',
    shop: '绿柳居、韩复兴', price: '人均45-80元', area: '全市' },
  { id: 'zhuangyuandou', name: '状元豆', emoji: '🥜', category: '小吃',
    desc: '夫子庙传统五香豆，香糯入味，寓意金榜题名，是游客必买手信。',
    shop: '夫子庙小吃街', price: '人均10-20元', area: '秦淮' },
  { id: 'zhengerigao', name: '蒸儿糕', emoji: '🍚', category: '小吃',
    desc: '南京传统早点，糯米粉蒸制，松软香甜，有芝麻、豆沙等馅料。',
    shop: '老门东早点摊', price: '人均5-10元', area: '秦淮' },
  { id: 'luyatou', name: '卤鸭头', emoji: '🦆', category: '小吃',
    desc: '卤味鸭头，香辣入味，啃起来满口香，佐酒下饭两相宜。',
    shop: '绿柳居、卤味老店', price: '人均10-20元', area: '全市' },
  { id: 'liuhezhutourou', name: '六合猪头肉', emoji: '🍖', category: '特色',
    desc: '南京六合名吃，卤制猪头肉，肥而不腻、入口即化，蘸蒜泥更香。',
    shop: '六合本地老店', price: '人均30-50元', area: '六合' },
  { id: 'nanjingxiangdu', name: '南京香肚', emoji: '🥓', category: '名菜',
    desc: '与板鸭齐名的南京特产，腊味香肚，蒸熟切片，咸香浓郁。',
    shop: '韩复兴、绿柳居', price: '人均30-60元', area: '全市' },
  { id: 'guchenghuxie', name: '固城湖大闸蟹', emoji: '🦀', category: '名菜',
    desc: '高淳固城湖大闸蟹，金秋时令，膏满黄肥、肉质鲜甜。',
    shop: '高淳水产市场', price: '人均80-200元', area: '高淳' },
  { id: 'shijincai', name: '什锦菜', emoji: '🥗', category: '名菜',
    desc: '南京年菜，十余种蔬菜切丝炒制，清爽解腻，寓意十全十美。',
    shop: '南京大牌档、老字号', price: '人均20-40元', area: '全市' },
  { id: 'cigushaorou', name: '慈姑烧肉', emoji: '🍲', category: '名菜',
    desc: '水八仙之一的慈姑，与五花肉红烧，慈姑粉糯、肉香浓郁。',
    shop: '淮扬菜馆', price: '人均45-80元', area: '全市' },
  { id: 'laolumian', name: '老卤面', emoji: '🍜', category: '面食',
    desc: '老卤汤头配手擀面，汤浓味厚、面劲道，是南京人的深夜食堂。',
    shop: '老门东、街头面馆', price: '人均15-25元', area: '秦淮' },
  { id: 'guihuaniangao', name: '桂花糖年糕', emoji: '🍡', category: '甜品',
    desc: '桂花糖炒年糕，软糯香甜、桂花香浓，一口回到童年。',
    shop: '莲湖糕团店', price: '人均10-20元', area: '秦淮' }
];
